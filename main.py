...
class BMSApp(App):
    def build(self):
        ...
        title = Label(text='5S1P-BMS', size_hint=(1, 0.1), font_size=150, bold=True)
        main_layout.add_widget(title)

        # Create additional sections for current, voltage, and temperature
        self.current_label = Label(text='Voltage (V):', font_size=150, bold=True)
        ...
        self.voltage_label = Label(text='Current (A):', font_size=150, bold=True)
        ...
        self.temperature_label = Label(text='Temperature (°C):', font_size=150, bold=True)
        ...
        current_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=100, spacing=40)
        ...
        voltage_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=100, spacing=40)
        ...
        temperature_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=100, spacing=40)
        ...
        self.soc_label = Label(text='State of Charge (SOC):', font_size=150, bold=True)
        ...
        soc_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=100, spacing=40)
        ...
        self.left_grid = GridLayout(cols=1, spacing=20, size_hint=(0.5, 1))  # Increased spacing between cells
        ...
        for i in range(1, 9):  # Starting serial number from 1 for 7 cells
            ...
            cell_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=100, spacing=40)

            # Create a label for the serial number
            serial_label = Label(text=f"Cell {i}", font_size=150, size_hint=(0.2, 1), bold=True)
        ...
        self.right_grid = GridLayout(cols=1, spacing=20, size_hint=(0.5, 1))  # Increased spacing between cells
